...
<body>
 ...
 <!--- Kepala -------------------------------------------------------------------------------------->              
        ...
        <div class="humberger__menu__contact">
            <ul>
                <li><i class="fa fa-envelope"></i> muhdsoleh7399@gmail.com</li>
...
<!-- Breadcrumb Section Begin -->
    ...
    <section class="product spad">
        ...
        <ul>
        <?php
    // Step 3: Fetch and display categories
    while ($row = mysqli_fetch_array($result)) {
        $category = htmlspecialchars($row['category']); // Escape for safety
        echo '<li><a href="shop-grid.php?cid=' . urlencode($category) . '">' . $category . '</a></li>';
    }
    ?>
        </ul>
    </div>
                                    ...
                                    <div class="latest-prdouct__slider__item">
                                        <a href="#" class="latest-product__item">
                                            ...
                                            <div class="latest-product__item__text">
                                                ...
                                                <span>RM<?php echo htmlentities($row['price']); ?></span>
                                            </div>  
                                            </a>
                                    </div>
                                </div>
...
<!---------------------------------------------PRODUCT DETAIL YG main --------------------------------------------------------------------------------->

<?php include('./jap5.php');?>
