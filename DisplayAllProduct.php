...
// Fetch categories
$categories_result = $con->query("SELECT DISTINCT id, categoryName FROM category");
                ...
                <div class="sidebar__item">
                    ...
                    <ul>
                        <?php while ($category_row = $categories_result->fetch_assoc()): ?>
                            <li><a href="shop-grid.php?cid=<?php echo urlencode($category_row['id']); ?>">
                                <?php echo htmlspecialchars($category_row['categoryName']); ?>
                            </a></li>
                        <?php endwhile; ?>
                    </ul>
                </div>
